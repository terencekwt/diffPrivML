...
## Motivating Example - Proof of differential privacy
...
Now that we have establish the functionality of differential privacy budget, we can dive into actual use cases that can be supported in this package. **diffPrivML** is mainly supported for classification tasks.
